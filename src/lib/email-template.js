        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 100%;">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 30px; text-align: center;">
              <img src="https://www.bfis.in/wp-content/uploads/2024/01/BFIS-LOGO-FINAL-02.png" alt="Brookfield International School" style="max-width: 180px; height: auto; margin-bottom: 10px;">
                ...
                <tr>
                  <td style="padding: 20px;">
                    ...
                    <p style="margin: 0; color: #92400e;">
                      <strong>🌐 Website:</strong> <a href="https://www.bfis.in/" target="_blank" style="color: #1e3a8a; text-decoration: none;">bfisenquiry@gmail.com</a>
                    </p>
                  </td>
                </tr>
              </table>
