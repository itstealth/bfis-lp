...
export default function Legacy() {
  return (
    <section className="bg-[#e0f2f1] py-20">
      <div className="container max-w-[1350px] mx-auto px-4">
        <div className="flex flex-col items-center justify-center">
          <div className="mb-12 inline-block rounded-full sm:bg-gradient-to-r from-teal-400 to-green-500 sm:px-8 sm:py-4">
            <h2 className="text-3xl font-bold text-black sm:text-white">
